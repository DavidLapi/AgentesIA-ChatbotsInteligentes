...
Nuestro primer paso es instalar las dependencias requeridas:
 
1. **speechrecognition** --> Convierte palabras de voz a texto.

2. **pyttsx3** --> *tts* significa texto a voz. Convierte las respuestas de la IA en palabras de voz.

3. **langchain_ollama** --> Arranca Ollama IA localmente para generar respuestas.

---

## Terminal

Nos vamos a la terminal con nuestra ruta de entorno de trabajo:
